...
public class Driver
{
	...
	private static void addItem(ResizeArray items) throws IOException
	{
		...
		System.out.println("Please enter the index you would like this item at.");
		...
		if(input <= items.size())
		{
			if(search(items, item) == -1)
			{
				...
				str = "This item already exists in the collection.";		
		}
		else
			str = "Item not added, out of array range.";
